// Paleta de marca dinamica: en vez de valores hex fijos, "primary" apunta a variables CSS
// (ver src/index.css y src/utils/theme.js) para que la plataforma pueda tener su propio color
// sin recompilar ni tocar ningun componente.
