...
/** Reemplaza alert()/confirm() nativos por toasts y un modal de confirmacion con el
...
export function NotifyProvider({ children }) {
  ...
  return (
    <NotifyContext.Provider value={{ notify, confirmDialog }}>
      ...
      <div className="fixed top-4 inset-x-4 sm:left-auto sm:right-4 z-[100] flex flex-col gap-2 sm:w-full sm:max-w-sm pointer-events-none">
        {toasts.map((t) => {
